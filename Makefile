...
PROJECT_NAME := provider-jet-azuread
...
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX := https://releases.hashicorp.com/terraform-provider-azuread/2.18.0
